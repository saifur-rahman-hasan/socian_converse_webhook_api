...
export default function AgnetInboxReplyForm() {
        ...
        <form action="#" className="relative">
            <div className="overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
                ...
                <textarea
                    ...
                    name="description"
                    id="description"
                    className="block w-full pt-4 resize-none border-0 py-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
