...
export default function ConnectWithMessenger({ workspace }){
						...
						<Disclosure.Button className="flex w-full items-start justify-between text-left text-gray-900">
							<div className="group relative flex items-start space-x-3 py-4 cursor-pointer">
								...
								<div className="min-w-0 flex-1">
									...
									<p className="text-sm text-gray-500">Connect your business account on Socian Converse and interact with your audience on messaging platforms. Utilize powerful human and AI bot support for managing customer conversations.</p>
								</div>
							</div>
