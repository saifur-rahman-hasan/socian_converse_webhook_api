...
export default function WorkspaceAddTeamMemberFormModal({ workspaceId, workspaceTeams }) {
	...
	return (
		<>
			...
			<button
				type="button"
				className="inline-flex rounded-md bg-indigo-600 py-1.5 px-3 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
				onClick={() => router.push('/workspaces/'+workspaceId+'/acl')}
			>
				Access Control
			</button>
											...
											<div className="mt-2">
												...
												{/* <div className={`mb-4`}>
													<MultipleSelectMenu
														...
														onSelected={setSelectedPermissions} />
												</div> */}
