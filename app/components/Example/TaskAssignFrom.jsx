...
export default function TaskAssignFrom({ setOpen }) {
  const [selectedAssignAgent, setSelectedAssignAgent] = useState(null);
  const [selectedAssignFrom, setSelectedAssignFrom] = useState(
    assignFromAgents[0]
  );
  ...
  const handleSave = () => {
    const taskAssignData = {
      selectedAssignAgent: selectedAssignAgent,
      selectedAssignFrom: selectedAssignFrom,
    };
        ...
        <div>
          ...
          <div className="mt-2">
            <Dropdown
              ...
              item={selectedAssignFrom}
              setItem={setSelectedAssignFrom}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-2">
            <Dropdown
              ...
              item={selectedAssignAgent}
              setItem={setSelectedAssignAgent}
            />
          </div>
        </div>
