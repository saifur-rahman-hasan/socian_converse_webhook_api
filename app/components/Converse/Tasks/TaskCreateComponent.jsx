...
const TaskCreateComponent = ({handleSelectedUser,handleSubmitButton,handleCancelButton, workspaceId,formError}) => {
    return (
        <div>
            <div className="text-center mb-8">
                <Square2StackIcon className="mx-auto h-12 w-12 text-gray-400"/>
                <h2 className="mt-2 text-base font-semibold leading-6 text-gray-900">Create Thread
                    Task</h2>
